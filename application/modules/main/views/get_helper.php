...
function getBusiType()
{
    ...
    sop_bustype.btype_autoid,
    sop_bustype.btype_name
    FROM
    sop_bustype");
...
$output = '';
    foreach($sql->result() as $rs){
        $output .='
        <option value="'.$rs->btype_name.'">'.$rs->btype_name.'</option>
        ';
    }
    echo $output;
}
        ...
        <div class="card-body">
            ...
            <div class="row form-group">
                <div class="col-md-6">
                    <div class="row form-group">
                        <div class="col-md-4">
                            <span style="padding-right:10px;"><b>ปริมาณที่จะใช้ต่อปี : </b>'.$rs->ms_productuse.'&nbsp;<span id="ms_productuse_title">ตัน</span></span>
                        </div>
                        <div class="col-md-4">
                            <span style="padding-right:10px;"><b>เปอร์เซ็นที่คาดว่าจะสำเร็จ : </b><span class="percensuccessImage">'.$rs->ms_percensuccess.'%</span></span>
                        </div>
                        <div class="col-md-4">
                            <span><b>Idea price : </b>'.$rs->ms_ideaprice.'&nbsp;<span id="ms_ideaprice_title">บาท/กก.</span></span>
                        </div>
                    </div>
            ...
            <div class="row">
                <table class="table table-bordered table-striped">
                    <tr>
                        <th>ปี ค.ศ.</th>
                        <th>ประมาณการยอดใช้ <span id="m_forcastuseYear_title">(ตัน)</span></th>
