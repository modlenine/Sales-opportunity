...
<head>
    ...
    <script>
        ...
        function initMap() {
            ...
            var latlng = new google.maps.LatLng(13.75618500472269, 100.50178655767212);
                            ...
                            <div class="form-row">
                                <div class="col-md-8">
                                    <div class="position-relative form-group">
                                        ...
                                        <select name="csvr_business" id="csvr_business" class="form-control" required>
                                            <option value="">กรุณาเลือก Business type</option>
                                            <?=getBusiType()?>
                                        </select>
